          ...
          <div className="py-6">
            ...
            <div className="h-56 sm:h-64 w-full relative bg-[#06080C] rounded-lg border border-white/[0.04] p-4 overflow-hidden">
              <svg className="w-full h-full overflow-visible" preserveAspectRatio="none" viewBox="0 0 800 200">
                ...
                {/* 3-Sigma Envelope */}
                <path
                  d="M 0 140 C 100 135, 200 145, 300 138 C 400 142, 500 135, 600 140 C 700 138, 800 142"
                  fill="none"
                ...
                {!showAnomaly ? (
                  <>
                    <path
                      d="M 0 150 C 100 144, 200 152, 300 146 C 400 148, 500 142, 600 147 C 700 145, 800 148 L 800 200 L 0 200 Z"
                      fill="url(#anomAreaNormal)"
                    />
                    <path
                      d="M 0 150 C 100 144, 200 152, 300 146 C 400 148, 500 142, 600 147 C 700 145, 800 148"
                      fill="none"
                      stroke="#34D399"
                      strokeWidth="2"
                    />
                  ...
                  <>
                    <path
                      d="M 0 150 C 100 144, 200 152, 300 146 C 380 144, 420 130, 480 35 C 530 20, 580 40, 640 45 C 720 48, 800 42 L 800 200 L 0 200 Z"
                      fill="url(#anomAreaBreach)"
                    />
                    <path
                      d="M 0 150 C 100 144, 200 152, 300 146 C 380 144, 420 130, 480 35 C 530 20, 580 40, 640 45 C 720 48, 800 42"
                      fill="none"
                      stroke="#EF4444"
                      strokeWidth="2"
                    />
