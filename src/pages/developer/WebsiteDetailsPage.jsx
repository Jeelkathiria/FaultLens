          ...
          <div className="flex items-start sm:items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2.5 flex-wrap">
                <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-white">{website.name}</h1>
              ...
              <div className="flex items-center gap-3 text-xs text-slate-400 mt-1 font-mono">
                ...
                >
                  <span>{website.displayUrl}</span>
                  <ExternalLink className="w-3 h-3" />
                </a>
                <span>•</span>
                <span>Last telemetry checked: {website.lastChecked}</span>
              </div>
            </div>
          </div>
              ...
              >
                <div>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="text-xs font-mono text-slate-400 mt-1 truncate">{api.endpoint}</div>
                  </div>
