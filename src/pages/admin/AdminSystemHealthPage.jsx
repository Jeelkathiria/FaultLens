...
import { faultLensSystemServices, systemMetrics } from '../../data/systemHealth';
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard
          title="Events / Sec"
          value={systemMetrics.eventsPerSec.toLocaleString()}
        ...
        <StatCard
          ...
          value={systemMetrics.processingLatency}
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {faultLensSystemServices.map((service, idx) => {
            return (
              <div
                key={idx}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3 py-3 border-y border-[#1E2633] font-mono text-xs my-3">
                    ...
                    <div>
                      ...
                      <div className="font-bold text-emerald-400 mt-0.5">{service.throughput}</div>
                    </div>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2">
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-xs font-mono">
              ...
              <span className="text-slate-100 font-bold">{systemMetrics.cpuLoad}</span>
            </div>
            <div className="w-full bg-[#080B12] rounded-full h-2.5 border border-[#1E2633] overflow-hidden">
              <div className="bg-indigo-500 h-2.5 rounded-full" style={{ width: systemMetrics.cpuLoad }} />
            </div>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-xs font-mono">
              ...
              <span className="text-slate-100 font-bold">{systemMetrics.memoryUsage}</span>
            </div>
            <div className="w-full bg-[#080B12] rounded-full h-2.5 border border-[#1E2633] overflow-hidden">
              <div className="bg-emerald-500 h-2.5 rounded-full" style={{ width: systemMetrics.memoryUsage }} />
            </div>
          </div>
        </div>
      </div>
